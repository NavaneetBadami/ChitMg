...
String agentName=AgentLoginController.agentName.get(agentId);	//map(k,v)String groupId=null; 
            ...
            <div class="sidebar-collapse">
				...
				<li class="text-center">
                    ...
                    <li>
                     ...
                     <li>
                        <a href="#"><i class="fa fa-desktop fa-3x"></i>Chit Group</a>
						<ul class="nav-second-level">
                            <li>
                                <a href="CreateChitGroup.jsp">New Chit Group</a>
                            </li>
                            <li>
                                <a href="#">Modify Group</a>
                            </li>
                            <li>
                    ...
                    <li>
                        <a  href="ViewGroups.jsp"><i class="fa fa-qrcode fa-3x"></i>View Group</a>
                    </li>
					<li>
                        <a href="#"><i class="fa fa-sitemap fa-3x"></i>Schemes<span class="fa arrow"></span></a>
                        <ul class="nav-second-level">
                            <li>
                                <a href="ViewScheme.jsp">View Schemes</a>
                            </li>
                            <li>
                                <a href="AddScheme.jsp">Add New Schemes</a>
                            </li>
                            <li>
                                <a href="#">Delete Schemes</a>
                            </li>
                        </ul>
                      </li>  
                      <li  >
                    ...
                    <li  >
                        <a  href="AgentBlank.jsp"  class="active-menu" ><i class="fa fa-square-o fa-3x"></i> Blank Page</a>
                    </li>	
                </ul>   
            </div>
		</nav> 	 
