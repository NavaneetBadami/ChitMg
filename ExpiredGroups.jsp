...
<div id="main-wrapper"> <!-- Main wrapper -->
       ...
       <div id="page-wrapper">  <!--  page Wrapper -->
          <div id="page-inner"> <!--  page inner-->	
						...
						<h4><font face="Verdana, Geneva, sans-serif" color="#FF0000">Expired Chit Groups</font></h4>   
                  		<hr/>		
	...
	<%
		...
		String sqlQuery="select *from group_details where agentid='"+agentId+"' AND grpStatus='EXPIRED'";
	...
	%>
				<div class="span3">
                   <div class=" panel-primary no-boder bg-color-red">
                       <div class="badge-important">
						...
						<div class="panel-footer  text-center back-footer-mehindi">
							<a class="btn btn-info" href="grpDetailsUrl?groupId=<%=groupId%>">Members</a>
							<a class="btn btn-info" href="#<%=groupId%>" class="tip" title="Click to View Details" data-toggle="modal">Details</a>
						</div>
					</div>
					...
					<div class="modal-header alert-error">
						...
						<h4 id="myModalLabel"><%=groupName%>&nbsp;Group Details. <font face="Verdana, Geneva, sans-serif" color="#FF0000">(Expired Chit Group)</font></h4>
					</div>
					...
					<div class="modal-body ">	<!-- MOdel Body  -->
							...
							<div class="span12">
                            	...
                            	<div class="span5">
                                	<h5 class="alert alert-error">Group Details</h5>
									<table class="table table-hover alert-error">
									<tr>
										<th>GROUP NAME</th>
										<td><%=groupName%></td>
									</tr>
                            	...
                            	<div class="span5">
                                	<h5 class="alert alert-error">Other Information</h5>
									<table class="table table-hover table-bordered alert-error">
										<tr>
										<th>MEMBERS</th>
										<td><%=totalmember%></td>
									</tr>
