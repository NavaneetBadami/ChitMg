  ...
  <div class="navbar navbar-static-top">   <!--Top nav Bar -->
    <div class="navbar-inner">
       ...
       <div id="page-wrapper">  <!--  page Wrapper -->
              <h4 class="alert alert-error"><font face="Verdana, Geneva, sans-serif" color="#408080">Hidden Schemes</font></h4>   
                <hr/>		
		<div id="page-inner"> <!--  page inner-->		
            ...
            <div class="col-md-2">			<!-- just description. -->
				<div class="panel  back-dash">
					<i class="fa fa-repeat fa-3x"></i>
					<strong>Hidden Schemes</strong>
					<p class="text-muted">These are the schemes which are not availble for the new agents, so you can also make them visible by pressing visible button.</p>
				</div>
            </div>
              <br>  
			...
			<%
						...
						String sqlQuery="select *from scheme_type where schemeStatus='HIDE' AND admid='"+adminId+"'";	//display only hidden schemes.
					...
					<div class="col-md-3 col-sm-12 col-xs-12 ">
						 <div class="main-temp-back">
						  <div class="row">
							<i class="fa fa-exchange fa-3x"></i> Scheme <%=schType%>
						  </div>
						</div>
						...
						<div class="panel-back-chit">
							<div class="text-box">
								<table class="table table-bordered alert-error">
								<tr><td><h5>Price:&nbsp;<%=schPrice%> Rs</h5></td></tr>
								<tr><td><h5>Validity:&nbsp;<%=schValidity%> Years</h5></td></tr>
								<tr><td><h5>Max Chit:&nbsp;<%=schType%> Groups</h5></td></tr>
                                <tr><td><a href="#<%=schId%>"data-toggle="collapse" class="tip" title="Click to make this scheme available."><i class="fa fa-arrow-circle-down fa-1x">More</i></a></td></tr>
                                
                                <tr><td>
                                    <div id="<%=schId%>" class="accordion-body collapse">
                                    <div class="accordion-inner" >
										<a class="btn btn-success tip" HREF="schStatusUrl?schemeId=<%=schId%>&status=visible">VISIBLE</a> 
                                    </div>
                                    </div>
                                </td></tr>
								</table>
